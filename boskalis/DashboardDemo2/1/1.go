...
// Document-Name: DashboardDemo2
// Version: 1
// Type or Namespace: _DashboardDemo2
// Dsl: 1

type _DashboardDemo2 struct {
...
func New_DashboardDemo2(workflowIOManager dependencies.WorkflowIOManager) *_DashboardDemo2 {
	return &_DashboardDemo2{
		dataMap:           map[string]interface{}{},
		EventMap:          map[string]Event{},
...
func (w *_DashboardDemo2) trackTaskComplete(taskName string) {
	timestamp := time.Now().Format(time.RFC3339)
	w.taskHistory[taskName] = timestamp
	w.logger.Info("Task completed: %s", taskName)
}

func (w *_DashboardDemo2) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _DashboardDemo2", err)
		return "", err
	}
...
func (w *_DashboardDemo2) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_DashboardDemo2) handleActivityRetryLoop(ctx workflow.Context, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
...
func (w *_DashboardDemo2) produceWorkflowTaskStart(ctx workflow.Context, taskName string, input map[string]interface{}) error {
...
func (w *_DashboardDemo2) produceWorkflowTaskCompletion(ctx workflow.Context, taskName string, outputMap map[string]interface{}) error {
	// Get workflow execution info
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_DashboardDemo2) safeExecuteActivity(ctx workflow.Context, activityName string, input interface{}) (interface{}, error) {
...
func (w *_DashboardDemo2) File_Copy1(ctx workflow.Context, input interface{}) error {
	...
	w.dataMap["activity-id"] = "eab26f66-31c4-49d0-9166-bca59255b841"
...
func (w *_DashboardDemo2) waitEvent(ctx workflow.Context, input interface{}, taskName string, EventType string) error {
...
func (w *_DashboardDemo2) CustomUpdateHandler(ctx workflow.Context, updateName string) error {
...
func (w *_DashboardDemo2) Pgp_Decrypter1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	w.dataMap["activity-id"] = "14237e40-d911-4b34-9121-27a894bffeb5"
...
func (w *_DashboardDemo2) Transformer_M1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	w.dataMap["activity-id"] = "32401917-f94b-4d61-ae3c-60fc7593c79c"
