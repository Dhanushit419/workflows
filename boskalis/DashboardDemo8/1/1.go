...
// Document-Name: DashboardDemo8
// Version: 1
// Type or Namespace: _DashboardDemo8
// Dsl: 1

type _DashboardDemo8 struct {
...
func New_DashboardDemo8(workflowIOManager dependencies.WorkflowIOManager) *_DashboardDemo8 {
	return &_DashboardDemo8{
		dataMap:           map[string]interface{}{},
		EventMap:          map[string]Event{},
...
func (w *_DashboardDemo8) trackTaskComplete(taskName string) {
...
func (w *_DashboardDemo8) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _DashboardDemo8", err)
		return "", err
	}
...
func (w *_DashboardDemo8) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_DashboardDemo8) handleActivityRetryLoop(ctx workflow.Context, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
...
func (w *_DashboardDemo8) produceWorkflowTaskStart(ctx workflow.Context, taskName string, input map[string]interface{}) error {
...
func (w *_DashboardDemo8) produceWorkflowTaskCompletion(ctx workflow.Context, taskName string, outputMap map[string]interface{}) error {
	// Get workflow execution info
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_DashboardDemo8) safeExecuteActivity(ctx workflow.Context, activityName string, input interface{}) (interface{}, error) {
...
func (w *_DashboardDemo8) File_Copy1(ctx workflow.Context, input interface{}) error {
	...
	if err != nil {
		...
		w.dataMap["activity-id"] = "1e552bd2-aa82-4d8d-9771-1fb11e4ddd60"
...
func (w *_DashboardDemo8) waitEvent(ctx workflow.Context, input interface{}, taskName string, EventType string) error {
...
func (w *_DashboardDemo8) CustomUpdateHandler(ctx workflow.Context, updateName string) error {
...
func (w *_DashboardDemo8) Pgp_Decrypter1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	if err != nil {
		...
		w.dataMap["activity-id"] = "e11d4066-d8ec-4c96-922f-cea68bec5dcf"
...
func (w *_DashboardDemo8) Transformer_M1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	if err != nil {
		...
		w.dataMap["activity-id"] = "b14bb6f1-b826-4407-915a-564c71dcc283"
