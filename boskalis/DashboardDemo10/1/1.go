...
// Document-Name: DashboardDemo10
// Version: 1
// Type or Namespace: _DashboardDemo10
// Dsl: 1

type _DashboardDemo10 struct {
...
func New_DashboardDemo10(workflowIOManager dependencies.WorkflowIOManager) *_DashboardDemo10 {
	return &_DashboardDemo10{
		dataMap:           map[string]interface{}{},
		EventMap:          map[string]Event{},
...
func (w *_DashboardDemo10) trackTaskComplete(taskName string) {
...
func (w *_DashboardDemo10) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _DashboardDemo10", err)
		return "", err
	}
...
func (w *_DashboardDemo10) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_DashboardDemo10) handleActivityRetryLoop(ctx workflow.Context, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
...
func (w *_DashboardDemo10) produceWorkflowTaskStart(ctx workflow.Context, taskName string, inputMap map[string]interface{}) error {
...
func (w *_DashboardDemo10) produceWorkflowTaskCompletion(ctx workflow.Context, taskName string, outputMap map[string]interface{}) error {
	// Get workflow execution info
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_DashboardDemo10) produceWorkflowCompletion(ctx workflow.Context, outputMap map[string]interface{}) error {
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_DashboardDemo10) safeExecuteActivity(ctx workflow.Context, activityName string, input interface{}) (interface{}, error) {
...
func (w *_DashboardDemo10) File_Copy1(ctx workflow.Context, input interface{}) error {
	...
	inputMap["activity-id"] = "49b30c89-0457-45a5-af76-f58b29add07b"
...
func (w *_DashboardDemo10) waitEvent(ctx workflow.Context, input interface{}, taskName string, EventType string) error {
...
func (w *_DashboardDemo10) CustomUpdateHandler(ctx workflow.Context, updateName string) error {
...
func (w *_DashboardDemo10) Transformer_M1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	inputMap["activity-id"] = "d3d1a87c-4d4c-41b9-a13c-d01816b6fb2f"
...
func (w *_DashboardDemo10) exit(ctx workflow.Context) {
