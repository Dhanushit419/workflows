...
// Document-Name: FinalTesting
// Version: 1.0.2
// Type or Namespace: _FinalTesting1
// Dsl: 1.0.2
...
func New_FinalTesting1(workflowIOManager dependencies.WorkflowIOManager) *_FinalTesting1 {
	return &_FinalTesting1{
		configMap:         map[string]interface{}{},
...
func (w *_FinalTesting1) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _FinalTesting1", err)
		return "", err
	}
	...
	// Execute first task
	if err := w.SendForCEOApproval1(ctx, instance,instance.dataMap); err != nil {
		return "", err
	}
...
func (w *_FinalTesting1) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_FinalTesting1) handleActivityRetryLoop(ctx workflow.Context, instance *WorkflowInstance, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
	...
	func (w *_FinalTesting1) produceWorkflowEvent(ctx workflow.Context, eventType string, taskName string, payload map[string]interface{}) error {
...
func (w *_FinalTesting1) safeExecuteActivity(ctx workflow.Context, instance *WorkflowInstance, activityName string, input interface{}) (interface{}, error) {
...
func (w *_FinalTesting1) SendForCEOApproval1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	instance.currentTask = "SendForCEOApproval1"
	instance.dataMap["current_task"] = instance.currentTask
	w.logger.Info("Executing task: SendForCEOApproval1\n")
	...
	w.logger.Info("dataMap: %s", dataMap)
		...
		inputMap := make(map[string]interface{})
			inputMap["employeeId"] = dataMap["employeeId"]
	inputMap["reason"] = dataMap["rejectionReason"]
...
_, err = w.safeExecuteActivity(ctx,instance, "FileCopyProxy", map[string]interface{}{"data_id": dataId})
	...
	err = w.waitEvent(ctx, instance, input, "SendForCEOApproval1", "file_copy.com")
	if err != nil {
		return err
	}
	...
	if err != nil {
		...
		w.SendForCEOApproval2(ctx,instance, input)
	return nil
}



func (w *_FinalTesting1) waitEvent(ctx workflow.Context, instance *WorkflowInstance, input interface{}, taskName string, EventType string) error {
...
func (w *_FinalTesting1) CustomUpdateHandler(ctx workflow.Context, instance *WorkflowInstance, updateName string) error {
...
func (w *_FinalTesting1) SendForCEOApproval2(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	instance.currentTask = "SendForCEOApproval2"
	instance.dataMap["current_task"] = instance.currentTask
	w.logger.Info("Executing task: SendForCEOApproval2\n")
...
_, err = w.safeExecuteActivity(ctx,instance, "FileCopyProxy", map[string]interface{}{"data_id": dataId})
	...
	err = w.waitEvent(ctx, instance, input, "SendForCEOApproval2", "file_copy.com")
	if err != nil {
		return err
	}
...
func (w *_FinalTesting1) exit(ctx workflow.Context,instance *WorkflowInstance) {
