...
// Document-Name: asdsdsd
// Version: 1
// Type or Namespace: _asdsdsd
// Dsl: 1

type _asdsdsd struct {
...
func New_asdsdsd(workflowIOManager dependencies.WorkflowIOManager) *_asdsdsd {
	return &_asdsdsd{
		dataMap:           map[string]interface{}{},
		EventMap:          map[string]Event{},
...
func (w *_asdsdsd) trackTaskComplete(taskName string) {
...
func (w *_asdsdsd) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _asdsdsd", err)
		return "", err
	}
...
func (w *_asdsdsd) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_asdsdsd) handleActivityRetryLoop(ctx workflow.Context, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
...
func (w *_asdsdsd) produceWorkflowTaskStart(ctx workflow.Context, taskName string, input map[string]interface{}) error {
...
func (w *_asdsdsd) produceWorkflowTaskCompletion(ctx workflow.Context, taskName string, outputMap map[string]interface{}) error {
	// Get workflow execution info
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_asdsdsd) safeExecuteActivity(ctx workflow.Context, activityName string, input interface{}) (interface{}, error) {
