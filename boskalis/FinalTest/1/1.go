...
func NewFinalTest(workflowIOManager dependencies.WorkflowIOManager) *FinalTest {
	return &FinalTest{
		dataMap:           map[string]interface{}{},
		EventMap:          map[string]Event{},
...
func (w *FinalTest) trackTaskComplete(taskName string) {
...
func (w *FinalTest) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : FinalTest", err)
		return "", err
	}
...
func (w *FinalTest) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *FinalTest) produceWorkflowTaskStart(ctx workflow.Context, taskName string) error {
...
func (w *FinalTest) produceWorkflowTaskCompletion(ctx workflow.Context, taskName string) error {
	// Get workflow execution info
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *FinalTest) safeExecuteActivity(ctx workflow.Context, activityName string, input interface{}) (interface{}, error) {
...
func (w *FinalTest) FileCopy1(ctx workflow.Context, input interface{}) error {
...
func (w *FinalTest) waitEvent(ctx workflow.Context, input interface{}, taskName string, EventType string) error {
...
func (w *FinalTest) CustomUpdateHandler(ctx workflow.Context, updateName string) error {
...
func (w *FinalTest) PgpDecrypter1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	w.logger.Info("inputMap: %s", inputMap)
		...
		w.dataMap["activity-id"] = "7e47c260-ceb3-407a-9956-aaa026078e33"
...
func (w *FinalTest) Transformer(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	w.logger.Info("inputMap: %s", inputMap)
		...
		w.dataMap["activity-id"] = "1ffb67a1-198d-4825-b8cc-c453dcf66828"
