...
// Document-Name: DemoOutboundPortal6
// Version: 1
// Type or Namespace: _DemoOutboundPortal6
// Dsl: 1
...
type _DemoOutboundPortal6 struct {
...
func New_DemoOutboundPortal6(workflowIOManager dependencies.WorkflowIOManager) *_DemoOutboundPortal6 {
	return &_DemoOutboundPortal6{
		configMap:         map[string]interface{}{},
...
func (w *_DemoOutboundPortal6) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _DemoOutboundPortal6", err)
		return "", err
	}
...
func (w *_DemoOutboundPortal6) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_DemoOutboundPortal6) handleActivityRetryLoop(ctx workflow.Context, instance *WorkflowInstance, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
...
func (w *_DemoOutboundPortal6) produceWorkflowEvent(ctx workflow.Context, eventType string, taskName string, payload map[string]interface{}) error {
...
func (w *_DemoOutboundPortal6) safeExecuteActivity(ctx workflow.Context, instance *WorkflowInstance, activityName string, input interface{}) (interface{}, error) {
...
func (w *_DemoOutboundPortal6) File_Copy1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	...
	inputMap["activity-id"] = "d09de5c7-584d-44df-a6d1-e4047a47704d"
...
func (w *_DemoOutboundPortal6) waitEvent(ctx workflow.Context, instance *WorkflowInstance, input interface{}, taskName string, EventType string) error {
...
func (w *_DemoOutboundPortal6) CustomUpdateHandler(ctx workflow.Context, instance *WorkflowInstance, updateName string) error {
...
func (w *_DemoOutboundPortal6) Transformer_M1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	...
	inputMap["activity-id"] = "8e9e89a5-f81a-4859-813d-eef26f49f9bd"
...
func (w *_DemoOutboundPortal6) File_Copy2(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	...
	inputMap := make(map[string]interface{})
	inputMap["activity-id"] = "35b3776a-98e9-4307-a69a-a9dd7ee9e23a"
	//print the eventMap
	w.logger.Info("eventMap: %s", instance.EventMap)
	inputMap["filecopy_in_file_names"] = instance.EventMap["Transformer_M1"].Result["transformer_m.out.file_names"]
	inputMap["filecopy_in_file_path"] = instance.EventMap["Transformer_M1"].Result["transformer_m.out.file_path"]
...
func (w *_DemoOutboundPortal6) exit(ctx workflow.Context, instance *WorkflowInstance) {
