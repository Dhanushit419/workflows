...
// Document-Name: DashboardFlow2
// Version: 1
// Type or Namespace: _DashboardFlow2
// Dsl: 1

type _DashboardFlow2 struct {
...
func New_DashboardFlow2(workflowIOManager dependencies.WorkflowIOManager) *_DashboardFlow2 {
	return &_DashboardFlow2{
		dataMap:           map[string]interface{}{},
		EventMap:          map[string]Event{},
...
func (w *_DashboardFlow2) trackTaskComplete(taskName string) {
...
func (w *_DashboardFlow2) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _DashboardFlow2", err)
		return "", err
	}
...
func (w *_DashboardFlow2) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_DashboardFlow2) handleActivityRetryLoop(ctx workflow.Context, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
...
func (w *_DashboardFlow2) produceWorkflowTaskStart(ctx workflow.Context, taskName string, input map[string]interface{}) error {
...
func (w *_DashboardFlow2) produceWorkflowTaskCompletion(ctx workflow.Context, taskName string, outputMap map[string]interface{}) error {
	// Get workflow execution info
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_DashboardFlow2) produceWorkflowCompletion(ctx workflow.Context, outputMap map[string]interface{}) error {
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_DashboardFlow2) safeExecuteActivity(ctx workflow.Context, activityName string, input interface{}) (interface{}, error) {
...
func (w *_DashboardFlow2) File_Copy1(ctx workflow.Context, input interface{}) error {
	...
	w.dataMap["activity-id"] = "bf4f28e3-8b6f-47ba-8149-812bc83f8566"
	dataId, err := w.PersistActualInput(ctx, w.dataMap)
	if err != nil {
...
func (w *_DashboardFlow2) waitEvent(ctx workflow.Context, input interface{}, taskName string, EventType string) error {
...
func (w *_DashboardFlow2) CustomUpdateHandler(ctx workflow.Context, updateName string) error {
...
func (w *_DashboardFlow2) Pgp_Decrypter1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	if err != nil {
		...
		w.dataMap["activity-id"] = "185d0586-bd72-42d8-9acf-6564b30bcc8e"
...
func (w *_DashboardFlow2) Transformer_M1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	w.dataMap["activity-id"] = "ce8b89f0-5f2f-4c8b-9c6b-6c88be6201e2"
	dataId, err := w.PersistActualInput(ctx, w.dataMap)
	if err != nil {
		w.logger.Error("Error persisting actual input: %%s",err)
		return err
...
func (w *_DashboardFlow2) exit(ctx workflow.Context) {
