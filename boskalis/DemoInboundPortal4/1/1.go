...
// Document-Name: DemoInboundPortal4
// Version: 1
// Type or Namespace: _DemoInboundPortal4
// Dsl: 1
...
type _DemoInboundPortal4 struct {
...
func New_DemoInboundPortal4(workflowIOManager dependencies.WorkflowIOManager) *_DemoInboundPortal4 {
	return &_DemoInboundPortal4{
		configMap:         map[string]interface{}{},
...
func (w *_DemoInboundPortal4) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _DemoInboundPortal4", err)
		return "", err
	}
...
func (w *_DemoInboundPortal4) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_DemoInboundPortal4) handleActivityRetryLoop(ctx workflow.Context, instance *WorkflowInstance, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
...
func (w *_DemoInboundPortal4) produceWorkflowEvent(ctx workflow.Context, eventType string, taskName string, payload map[string]interface{}) error {
...
func (w *_DemoInboundPortal4) safeExecuteActivity(ctx workflow.Context, instance *WorkflowInstance, activityName string, input interface{}) (interface{}, error) {
...
func (w *_DemoInboundPortal4) File_Copy1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	...
	inputMap["activity-id"] = "e85bb117-7d02-472b-a5c4-d46e54a80e74"
...
func (w *_DemoInboundPortal4) waitEvent(ctx workflow.Context, instance *WorkflowInstance, input interface{}, taskName string, EventType string) error {
...
func (w *_DemoInboundPortal4) CustomUpdateHandler(ctx workflow.Context, instance *WorkflowInstance, updateName string) error {
...
func (w *_DemoInboundPortal4) Transformer_M1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	...
	inputMap := make(map[string]interface{})
	inputMap["activity-id"] = "f291e020-6fdb-472e-8799-560e28ffec1b"
	...
	w.Data_Loader1(ctx, instance, input)
	return nil
}

func (w *_DemoInboundPortal4) Data_Loader1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	instance.currentTask = "Data_Loader1"
	instance.dataMap["current_task"] = instance.currentTask
	w.logger.Info("Executing task: Data_Loader1\n")
	...
	inputMap := make(map[string]interface{})
	inputMap["dataloader_in_file_path"] = "%!s(<nil>)"
	inputMap["activity-id"] = "585231ce-2a09-4218-914a-374c36f2a4dd"
	inputMap["dataloader_in_file_names"] = "%!s(<nil>)"
	...
	_, err = w.safeExecuteActivity(ctx, instance, "EnqueueWorkitem", map[string]interface{}{"data_id": dataId})
	if err != nil {
		w.logger.Error("Workflow terminated during activity execution", zap.Error(err))
		return err
	}
	...
	instance.dataMap["Data_Loader1"] = resultValues[0]
...
func (w *_DemoInboundPortal4) exit(ctx workflow.Context, instance *WorkflowInstance) {
