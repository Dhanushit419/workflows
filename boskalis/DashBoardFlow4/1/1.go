...
// Document-Name: DashBoardFlow4
// Version: 1
// Type or Namespace: _DashBoardFlow4
// Dsl: 1

type _DashBoardFlow4 struct {
...
func New_DashBoardFlow4(workflowIOManager dependencies.WorkflowIOManager) *_DashBoardFlow4 {
	return &_DashBoardFlow4{
		dataMap:           map[string]interface{}{},
		EventMap:          map[string]Event{},
...
func (w *_DashBoardFlow4) trackTaskComplete(taskName string) {
...
func (w *_DashBoardFlow4) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _DashBoardFlow4", err)
		return "", err
	}
...
func (w *_DashBoardFlow4) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_DashBoardFlow4) handleActivityRetryLoop(ctx workflow.Context, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
...
func (w *_DashBoardFlow4) produceWorkflowTaskStart(ctx workflow.Context, taskName string, input map[string]interface{}) error {
...
func (w *_DashBoardFlow4) produceWorkflowTaskCompletion(ctx workflow.Context, taskName string, outputMap map[string]interface{}) error {
	// Get workflow execution info
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_DashBoardFlow4) produceWorkflowCompletion(ctx workflow.Context, outputMap map[string]interface{}) error {
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_DashBoardFlow4) safeExecuteActivity(ctx workflow.Context, activityName string, input interface{}) (interface{}, error) {
...
func (w *_DashBoardFlow4) File_Copy1(ctx workflow.Context, input interface{}) error {
	...
	if err != nil {
		...
		w.dataMap["activity-id"] = "f7d9eb7a-ac8a-421b-9912-659c866e21a9"
...
func (w *_DashBoardFlow4) waitEvent(ctx workflow.Context, input interface{}, taskName string, EventType string) error {
...
func (w *_DashBoardFlow4) CustomUpdateHandler(ctx workflow.Context, updateName string) error {
...
func (w *_DashBoardFlow4) Pgp_Decrypter1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	w.dataMap["activity-id"] = "0a676eda-57e7-42d8-aa77-8b8ab1eb617b"
...
func (w *_DashBoardFlow4) Transformer_M1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	if err != nil {
		...
		w.dataMap["activity-id"] = "eb5a8c56-2c7e-4511-98a5-d6d0be5ed4ff"
...
func (w *_DashBoardFlow4) exit(ctx workflow.Context) {
