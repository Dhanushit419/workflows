...
// Document-Name: DemoOutboundPortal4
// Version: 1
// Type or Namespace: _DemoOutboundPortal4
// Dsl: 1
...
type WorkflowInstance struct {
	...
	type _DemoOutboundPortal4 struct {
...
func New_DemoOutboundPortal4(workflowIOManager dependencies.WorkflowIOManager) *_DemoOutboundPortal4 {
	return &_DemoOutboundPortal4{
		configMap:         map[string]interface{}{},
...
func (w *_DemoOutboundPortal4) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _DemoOutboundPortal4", err)
		return "", err
	}
	...
	// Execute first task
	if err := w.Transformer_M1(ctx, instance,instance.dataMap); err != nil {
		return "", err
	}
...
func (w *_DemoOutboundPortal4) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_DemoOutboundPortal4) handleActivityRetryLoop(ctx workflow.Context, instance *WorkflowInstance, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
	...
	func (w *_DemoOutboundPortal4) produceWorkflowEvent(ctx workflow.Context, eventType string, taskName string, payload map[string]interface{}) error {
...
func (w *_DemoOutboundPortal4) safeExecuteActivity(ctx workflow.Context, instance *WorkflowInstance, activityName string, input interface{}) (interface{}, error) {
...
func (w *_DemoOutboundPortal4) Transformer_M1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	...
	w.logger.Info("dataMap: %s", dataMap)
		...
		inputMap := make(map[string]interface{})
			inputMap["transformerm_in_file_names"] = instance.EventMap["Trigger"].Result["file_listener.out.file_names"]
	inputMap["transformerm_in_file_path"] = instance.EventMap["Trigger"].Result["file_listener.out.file_path"]
	inputMap["activity-id"] = "b68d9ded-81d0-4e9f-ae33-2bd6ca6f4869"
...
_, err = w.safeExecuteActivity(ctx,instance, "TxRunManualProcess", map[string]interface{}{"data_id": dataId})
	if err != nil {
		w.logger.Error("Workflow terminated during activity execution", zap.Error(err))
		return err
	}
	err = w.CustomUpdateHandler(ctx,instance, "TxRunManualProcess")
	if err != nil {
		return err
	}
...
func (w *_DemoOutboundPortal4) waitEvent(ctx workflow.Context, instance *WorkflowInstance, input interface{}, taskName string, EventType string) error {
...
func (w *_DemoOutboundPortal4) CustomUpdateHandler(ctx workflow.Context, instance *WorkflowInstance, updateName string) error {
...
func (w *_DemoOutboundPortal4) Pgp_Encrypter1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	...
	w.logger.Info("dataMap: %s", dataMap)
		...
		inputMap := make(map[string]interface{})
			inputMap["pgpencryptor_in_file_path"] = instance.EventMap["Transformer_M1"].Result["transformer_m.out.file_path"]
	inputMap["activity-id"] = "47fca1ac-36dc-438a-bbca-e132aba75e72"
	inputMap["pgpencryptor_in_file_names"] = instance.EventMap["Transformer_M1"].Result["transformer_m.out.file_names"]
...
_, err = w.safeExecuteActivity(ctx,instance, "PGPEncryptorProxy", map[string]interface{}{"data_id": dataId})
	...
	if err != nil {
		...
		w.File_Copy1(ctx,instance, input)
	return nil
}

func (w *_DemoOutboundPortal4) File_Copy1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	...
	w.logger.Info("dataMap: %s", dataMap)
		...
		inputMap := make(map[string]interface{})
			inputMap["activity-id"] = "ca013ecc-a46c-4e38-95f4-ad594b7707f7"
...
func (w *_DemoOutboundPortal4) exit(ctx workflow.Context,instance *WorkflowInstance) {
