...
// Document-Name: Dashboardtesting4
// Version: 1
// Type or Namespace: _Dashboardtesting4
// Dsl: 1

type _Dashboardtesting4 struct {
...
func New_Dashboardtesting4(workflowIOManager dependencies.WorkflowIOManager) *_Dashboardtesting4 {
	return &_Dashboardtesting4{
		dataMap:           map[string]interface{}{},
		EventMap:          map[string]Event{},
...
func (w *_Dashboardtesting4) trackTaskComplete(taskName string) {
...
func (w *_Dashboardtesting4) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _Dashboardtesting4", err)
		return "", err
	}
...
func (w *_Dashboardtesting4) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_Dashboardtesting4) handleActivityRetryLoop(ctx workflow.Context, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
...
func (w *_Dashboardtesting4) produceWorkflowTaskStart(ctx workflow.Context, taskName string, input map[string]interface{}) error {
...
func (w *_Dashboardtesting4) produceWorkflowTaskCompletion(ctx workflow.Context, taskName string, outputMap map[string]interface{}) error {
	// Get workflow execution info
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_Dashboardtesting4) safeExecuteActivity(ctx workflow.Context, activityName string, input interface{}) (interface{}, error) {
...
func (w *_Dashboardtesting4) File_Copy1(ctx workflow.Context, input interface{}) error {
	...
	if err != nil {
		...
		w.dataMap["activity-id"] = "c0d35266-46d1-461f-934c-706ecd0f3025"
...
func (w *_Dashboardtesting4) waitEvent(ctx workflow.Context, input interface{}, taskName string, EventType string) error {
...
func (w *_Dashboardtesting4) CustomUpdateHandler(ctx workflow.Context, updateName string) error {
...
func (w *_Dashboardtesting4) Pgp_Decrypter1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	w.dataMap["activity-id"] = "3be79106-9205-47a2-872e-d616d7746194"
...
func (w *_Dashboardtesting4) Transformer_M1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	if err != nil {
		...
		w.dataMap["activity-id"] = "081793bd-aceb-4c55-86b1-9030e7d4931f"
...
func (w *_Dashboardtesting4) exit() {
