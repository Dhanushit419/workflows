...
// Document-Name: DashboardDemo6
// Version: 1
// Type or Namespace: _DashboardDemo6
// Dsl: 1

type _DashboardDemo6 struct {
...
func New_DashboardDemo6(workflowIOManager dependencies.WorkflowIOManager) *_DashboardDemo6 {
	return &_DashboardDemo6{
		dataMap:           map[string]interface{}{},
		EventMap:          map[string]Event{},
...
func (w *_DashboardDemo6) trackTaskComplete(taskName string) {
...
func (w *_DashboardDemo6) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _DashboardDemo6", err)
		return "", err
	}
...
func (w *_DashboardDemo6) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_DashboardDemo6) handleActivityRetryLoop(ctx workflow.Context, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
...
func (w *_DashboardDemo6) produceWorkflowTaskStart(ctx workflow.Context, taskName string, input map[string]interface{}) error {
...
func (w *_DashboardDemo6) produceWorkflowTaskCompletion(ctx workflow.Context, taskName string, outputMap map[string]interface{}) error {
	// Get workflow execution info
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_DashboardDemo6) safeExecuteActivity(ctx workflow.Context, activityName string, input interface{}) (interface{}, error) {
...
func (w *_DashboardDemo6) File_Copy1(ctx workflow.Context, input interface{}) error {
	...
	if err != nil {
		...
		w.dataMap["activity-id"] = "fa06cd15-4d1d-4bc5-bced-db886d64eecb"
...
func (w *_DashboardDemo6) waitEvent(ctx workflow.Context, input interface{}, taskName string, EventType string) error {
...
func (w *_DashboardDemo6) CustomUpdateHandler(ctx workflow.Context, updateName string) error {
...
func (w *_DashboardDemo6) Pgp_Decrypter1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	if err != nil {
		...
		w.dataMap["activity-id"] = "9320fba7-f118-4a55-ad61-572d81a3405e"
...
func (w *_DashboardDemo6) Transformer_M1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	w.dataMap["activity-id"] = "4c40e5ff-c805-40e2-bc62-04e6293a2fe8"
	dataId, err := w.PersistActualInput(ctx, w.dataMap)
	if err != nil {
		w.logger.Error("Error persisting actual input: %%s",err)
		return err
