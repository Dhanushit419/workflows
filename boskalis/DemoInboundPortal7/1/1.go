...
// Document-Name: DemoInboundPortal7
// Version: 1
// Type or Namespace: _DemoInboundPortal7
// Dsl: 1
...
type _DemoInboundPortal7 struct {
...
func New_DemoInboundPortal7(workflowIOManager dependencies.WorkflowIOManager) *_DemoInboundPortal7 {
	return &_DemoInboundPortal7{
		configMap:         map[string]interface{}{},
...
func (w *_DemoInboundPortal7) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _DemoInboundPortal7", err)
		return "", err
	}
...
func (w *_DemoInboundPortal7) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_DemoInboundPortal7) handleActivityRetryLoop(ctx workflow.Context, instance *WorkflowInstance, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
...
func (w *_DemoInboundPortal7) produceWorkflowEvent(ctx workflow.Context, eventType string, taskName string, payload map[string]interface{}) error {
...
func (w *_DemoInboundPortal7) safeExecuteActivity(ctx workflow.Context, instance *WorkflowInstance, activityName string, input interface{}) (interface{}, error) {
...
func (w *_DemoInboundPortal7) File_Copy1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	...
	inputMap["activity-id"] = "e8bd0f0c-6268-451e-9b5d-58ac494e5f92"
...
func (w *_DemoInboundPortal7) waitEvent(ctx workflow.Context, instance *WorkflowInstance, input interface{}, taskName string, EventType string) error {
...
func (w *_DemoInboundPortal7) CustomUpdateHandler(ctx workflow.Context, instance *WorkflowInstance, updateName string) error {
...
func (w *_DemoInboundPortal7) Transformer_M1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	...
	inputMap := make(map[string]interface{})
	inputMap["activity-id"] = "e4f11ac9-0736-4cb3-aefc-c863cccab1f8"
...
func (w *_DemoInboundPortal7) Data_Loader1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	...
	inputMap := make(map[string]interface{})
	inputMap["setName"] = "RDEX_TESTING"
	inputMap["activity-id"] = "b9a49aed-4116-45aa-9b28-d18e7dc3264f"
	...
	_, err = w.safeExecuteActivity(ctx, instance, "EnqueueWorkitemActivity", map[string]interface{}{"data_id": dataId})
	if err != nil {
		w.logger.Error("Workflow terminated during activity execution", zap.Error(err))
		return err
	}
...
func (w *_DemoInboundPortal7) exit(ctx workflow.Context, instance *WorkflowInstance) {
