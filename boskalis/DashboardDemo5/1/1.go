...
// Document-Name: DashboardDemo5
// Version: 1
// Type or Namespace: _DashboardDemo5
// Dsl: 1

type _DashboardDemo5 struct {
...
func New_DashboardDemo5(workflowIOManager dependencies.WorkflowIOManager) *_DashboardDemo5 {
	return &_DashboardDemo5{
		dataMap:           map[string]interface{}{},
		EventMap:          map[string]Event{},
...
func (w *_DashboardDemo5) trackTaskComplete(taskName string) {
...
func (w *_DashboardDemo5) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _DashboardDemo5", err)
		return "", err
	}
...
func (w *_DashboardDemo5) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_DashboardDemo5) handleActivityRetryLoop(ctx workflow.Context, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
...
func (w *_DashboardDemo5) produceWorkflowTaskStart(ctx workflow.Context, taskName string, input map[string]interface{}) error {
...
func (w *_DashboardDemo5) produceWorkflowTaskCompletion(ctx workflow.Context, taskName string, outputMap map[string]interface{}) error {
	// Get workflow execution info
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_DashboardDemo5) safeExecuteActivity(ctx workflow.Context, activityName string, input interface{}) (interface{}, error) {
...
func (w *_DashboardDemo5) File_Copy1(ctx workflow.Context, input interface{}) error {
	...
	w.dataMap["activity-id"] = "a15fba68-fe7e-45bd-a883-f04e3974954c"
	dataId, err := w.PersistActualInput(ctx, w.dataMap)
	if err != nil {
...
func (w *_DashboardDemo5) waitEvent(ctx workflow.Context, input interface{}, taskName string, EventType string) error {
...
func (w *_DashboardDemo5) CustomUpdateHandler(ctx workflow.Context, updateName string) error {
...
func (w *_DashboardDemo5) Pgp_Decrypter1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	if err != nil {
		...
		w.dataMap["activity-id"] = "56638c33-4cde-4288-9e42-105d0c8f54d9"
...
func (w *_DashboardDemo5) Transformer_M1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	if err != nil {
		...
		w.dataMap["activity-id"] = "ae512d5f-d8db-44a6-9118-cd2183d2b975"
