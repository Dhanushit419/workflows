...
// Document-Name: DashboardFlow9
// Version: 1
// Type or Namespace: _DashboardFlow9
// Dsl: 1

type _DashboardFlow9 struct {
...
func New_DashboardFlow9(workflowIOManager dependencies.WorkflowIOManager) *_DashboardFlow9 {
	return &_DashboardFlow9{
		dataMap:           map[string]interface{}{},
		EventMap:          map[string]Event{},
...
func (w *_DashboardFlow9) trackTaskComplete(taskName string) {
...
func (w *_DashboardFlow9) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _DashboardFlow9", err)
		return "", err
	}
...
func (w *_DashboardFlow9) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_DashboardFlow9) handleActivityRetryLoop(ctx workflow.Context, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
...
func (w *_DashboardFlow9) produceWorkflowTaskStart(ctx workflow.Context, taskName string, inputMap map[string]interface{}) error {
...
func (w *_DashboardFlow9) produceWorkflowTaskCompletion(ctx workflow.Context, taskName string, outputMap map[string]interface{}) error {
	// Get workflow execution info
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_DashboardFlow9) produceWorkflowCompletion(ctx workflow.Context, outputMap map[string]interface{}) error {
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_DashboardFlow9) safeExecuteActivity(ctx workflow.Context, activityName string, input interface{}) (interface{}, error) {
...
func (w *_DashboardFlow9) File_Copy1(ctx workflow.Context, input interface{}) error {
	...
	inputMap["activity-id"] = "14006f1c-1ee6-4a26-a2b5-499a622ffe51"
...
func (w *_DashboardFlow9) waitEvent(ctx workflow.Context, input interface{}, taskName string, EventType string) error {
...
func (w *_DashboardFlow9) CustomUpdateHandler(ctx workflow.Context, updateName string) error {
...
func (w *_DashboardFlow9) Transformer_M1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	w.logger.Info("dataMap: %s", dataMap)
		...
		inputMap := make(map[string]interface{})
			inputMap["activity-id"] = "9099a80f-5e16-407c-9ca0-bf111a605f75"
...
func (w *_DashboardFlow9) exit(ctx workflow.Context) {
