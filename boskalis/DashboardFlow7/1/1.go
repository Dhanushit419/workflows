...
// Document-Name: DashboardFlow7
// Version: 1
// Type or Namespace: _DashboardFlow7
// Dsl: 1

type _DashboardFlow7 struct {
...
func New_DashboardFlow7(workflowIOManager dependencies.WorkflowIOManager) *_DashboardFlow7 {
	return &_DashboardFlow7{
		dataMap:           map[string]interface{}{},
		EventMap:          map[string]Event{},
...
func (w *_DashboardFlow7) trackTaskComplete(taskName string) {
...
func (w *_DashboardFlow7) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _DashboardFlow7", err)
		return "", err
	}
...
func (w *_DashboardFlow7) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_DashboardFlow7) handleActivityRetryLoop(ctx workflow.Context, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
...
func (w *_DashboardFlow7) produceWorkflowTaskStart(ctx workflow.Context, taskName string, inputMap map[string]interface{}) error {
...
func (w *_DashboardFlow7) produceWorkflowTaskCompletion(ctx workflow.Context, taskName string, outputMap map[string]interface{}) error {
	// Get workflow execution info
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_DashboardFlow7) produceWorkflowCompletion(ctx workflow.Context, outputMap map[string]interface{}) error {
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_DashboardFlow7) safeExecuteActivity(ctx workflow.Context, activityName string, input interface{}) (interface{}, error) {
...
func (w *_DashboardFlow7) File_Copy1(ctx workflow.Context, input interface{}) error {
	...
	inputMap["activity-id"] = "98b9927e-dd7d-49d8-b9e9-13c7c92f424c"

	delete(w.dataMap, "input")
...
func (w *_DashboardFlow7) waitEvent(ctx workflow.Context, input interface{}, taskName string, EventType string) error {
...
func (w *_DashboardFlow7) CustomUpdateHandler(ctx workflow.Context, updateName string) error {
...
func (w *_DashboardFlow7) Transformer_M1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
	...
	w.logger.Info("dataMap: %s", dataMap)
		...
		inputMap := make(map[string]interface{})
			inputMap["activity-id"] = "fedb1ee3-ec7c-4fd8-ae39-85054b420d88"
	inputMap["transformerm_in_file_names"] = w.EventMap["File_Copy1"].Result["file_copy.out.file_names"]
	inputMap["transformerm_in_file_path"] = w.EventMap["File_Copy1"].Result["file_copy.out.file_path"]
...
func (w *_DashboardFlow7) exit(ctx workflow.Context) {
