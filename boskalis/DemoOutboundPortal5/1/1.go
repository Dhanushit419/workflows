...
// Document-Name: DemoOutboundPortal5
// Version: 1
// Type or Namespace: _DemoOutboundPortal5
// Dsl: 1
...
type WorkflowInstance struct {
	...
	type _DemoOutboundPortal5 struct {
...
func New_DemoOutboundPortal5(workflowIOManager dependencies.WorkflowIOManager) *_DemoOutboundPortal5 {
	return &_DemoOutboundPortal5{
		configMap:         map[string]interface{}{},
...
func (w *_DemoOutboundPortal5) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _DemoOutboundPortal5", err)
		return "", err
	}
...
func (w *_DemoOutboundPortal5) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_DemoOutboundPortal5) handleActivityRetryLoop(ctx workflow.Context, instance *WorkflowInstance, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
	...
	func (w *_DemoOutboundPortal5) produceWorkflowEvent(ctx workflow.Context, eventType string, taskName string, payload map[string]interface{}) error {
...
func (w *_DemoOutboundPortal5) safeExecuteActivity(ctx workflow.Context, instance *WorkflowInstance, activityName string, input interface{}) (interface{}, error) {
...
func (w *_DemoOutboundPortal5) Transformer_M1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	...
	w.logger.Info("dataMap: %s", dataMap)
		...
		inputMap := make(map[string]interface{})
			inputMap["activity-id"] = "80218f55-c4a4-4051-a0a7-b6e6e53ad4cf"
...
func (w *_DemoOutboundPortal5) waitEvent(ctx workflow.Context, instance *WorkflowInstance, input interface{}, taskName string, EventType string) error {
...
func (w *_DemoOutboundPortal5) CustomUpdateHandler(ctx workflow.Context, instance *WorkflowInstance, updateName string) error {
...
func (w *_DemoOutboundPortal5) File_Copy1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	...
	w.logger.Info("dataMap: %s", dataMap)
		...
		inputMap := make(map[string]interface{})
			inputMap["activity-id"] = "a7bfa8a2-8b38-4561-8e02-2bb31500f6f1"
...
func (w *_DemoOutboundPortal5) exit(ctx workflow.Context,instance *WorkflowInstance) {
