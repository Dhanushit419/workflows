...
// Version: 1
// Type or Namespace: _DashboardTesting2
// Dsl: 1

type _DashboardTesting2 struct {
...
func New_Dashboardtesting2(workflowIOManager dependencies.WorkflowIOManager) *_DashboardTesting2 {
	return &_DashboardTesting2{
		dataMap:           map[string]interface{}{},
		EventMap:          map[string]Event{},
...
// Create a wrapper for the input that includes attempt information
type ActivityInputWrapper struct {
...
func (w *_DashboardTesting2) trackTaskComplete(taskName string) {
	timestamp := time.Now().Format(time.RFC3339)
	w.taskHistory[taskName] = timestamp
	w.logger.Info("Task completed: %s", taskName)
}

func (w *_DashboardTesting2) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _DashboardTesting2", err)
		return "", err
	}
...
func (w *_DashboardTesting2) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_DashboardTesting2) handleActivityRetryLoop(ctx workflow.Context, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
...
func (w *_DashboardTesting2) produceWorkflowTaskStart(ctx workflow.Context, taskName string, input map[string]interface{}) error {
...
func (w *_DashboardTesting2) produceWorkflowTaskCompletion(ctx workflow.Context, taskName string, outputMap map[string]interface{}) error {
	// Get workflow execution info
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_DashboardTesting2) produceWorkflowCompletion(ctx workflow.Context, outputMap map[string]interface{}) error {
	info := workflow.GetInfo(ctx)
	workflowID := info.WorkflowExecution.ID
	runID := info.WorkflowExecution.RunID
...
func (w *_DashboardTesting2) safeExecuteActivity(ctx workflow.Context, activityName string, input interface{}) (interface{}, error) {
...
func (w *_DashboardTesting2) File_Copy1(ctx workflow.Context, input interface{}) error {
...
func (w *_DashboardTesting2) waitEvent(ctx workflow.Context, input interface{}, taskName string, EventType string) error {
...
func (w *_DashboardTesting2) CustomUpdateHandler(ctx workflow.Context, updateName string) error {
...
func (w *_DashboardTesting2) Pgp_Decrypter1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
...
func (w *_DashboardTesting2) Transformer_M1(ctx workflow.Context, input interface{}) error {
	w.previousTask = w.currentTask
...
func (w *_DashboardTesting2) exit(ctx workflow.Context) {
