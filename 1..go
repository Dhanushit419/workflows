...
// Document-Name: RdexDemoFlowManager2
// Version: 1
// Type or Namespace: _RdexDemoFlowManager2
// Dsl: 1
...
type _RdexDemoFlowManager2 struct {
...
func New_RdexDemoFlowManager2(workflowIOManager dependencies.WorkflowIOManager) *_RdexDemoFlowManager2 {
	return &_RdexDemoFlowManager2{
		configMap:         map[string]interface{}{},
...
func (w *_RdexDemoFlowManager2) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	ao := workflow.ActivityOptions{
		...
		TaskQueue:           strings.Replace(workflow.GetInfo(ctx).TaskQueueName, "workflows", "activities", 1),
	}
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _RdexDemoFlowManager2", err)
		return "", err
	}
...
func (w *_RdexDemoFlowManager2) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_RdexDemoFlowManager2) handleActivityRetryLoop(ctx workflow.Context, instance *WorkflowInstance, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
...
func (w *_RdexDemoFlowManager2) produceWorkflowEvent(ctx workflow.Context, eventType string, taskName string, payload map[string]interface{}) error {
...
func (w *_RdexDemoFlowManager2) safeExecuteActivity(ctx workflow.Context, instance *WorkflowInstance, activityName string, input interface{}) (interface{}, error) {
...
func (w *_RdexDemoFlowManager2) File_Copy1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	...
	inputMap["activity-id"] = "7c2bad17-8ad6-4dd4-8b81-2544edc286a5"
	...
	inputMap["tenant_id"] = instance.EventMap["Trigger"].Result["tenant_id"]
...
func (w *_RdexDemoFlowManager2) waitEvent(ctx workflow.Context, instance *WorkflowInstance, input interface{}, taskName string, EventType string) error {
	w.logger.Info("Waiting for event: " + taskName + "\n")
	err := workflow.Await(ctx, func() bool {
		//log the eventMap
		w.logger.Info("eventMap: %s", instance.EventMap)
		if result, exists := instance.EventMap["filecopy.filecopied"]; exists {
	...
	//log the eventMap
	w.logger.Info("eventMap: %s", instance.EventMap)
	if event, exists := instance.EventMap["filecopy.filecopied"]; exists {
		...
		if (hasSuccessField && isSuccessStr == "false") ||
			...
			checkEventSuccess := func() (interface{}, error) {
				...
				if updatedEvent, exists := instance.EventMap["filecopy.filecopied"]; exists {
			...
			if resultMap, ok := result.(map[string]interface{}); ok {
				event := instance.EventMap["filecopy.filecopied"]
				event.Result = resultMap
				instance.EventMap["filecopy.filecopied"] = event
			}
		}
	}
...
func (w *_RdexDemoFlowManager2) CustomUpdateHandler(ctx workflow.Context, instance *WorkflowInstance, updateName string) error {
	...
	err := workflow.SetUpdateHandler(ctx, updateName, func(ctx workflow.Context, updateRequest interface{}) (interface{}, error) {
		...
		//log the requestMap
		w.logger.Info("requestMap: %s", requestMap)
		resultValues, err := w.workflowIOManager.GetActualResult(workflow.GetInfo(ctx).Namespace, requestMap)
		if err != nil {
			return nil, err
		}
		//log the resultValues
		w.logger.Info("resultValues: %s", resultValues)
		var request Event
...
func (w *_RdexDemoFlowManager2) Transformer_M1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	...
	inputMap := make(map[string]interface{})
	inputMap["activity-id"] = "b063f3af-2199-4f1f-b120-53c6cfafe4fa"
	inputMap["transformerm_in_file_names"] = instance.EventMap["File_Copy1"].Result["file_copy.out.file_names"]
	inputMap["transformerm_in_file_path"] = instance.EventMap["File_Copy1"].Result["file_copy.out.file_path"]
	...
	w.Pgp_Encrypter1(ctx, instance, input)
	return nil
}

func (w *_RdexDemoFlowManager2) Pgp_Encrypter1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	instance.currentTask = "Pgp_Encrypter1"
	instance.dataMap["current_task"] = instance.currentTask
	w.logger.Info("Executing task: Pgp_Encrypter1\n")
	...
	inputMap := make(map[string]interface{})
	inputMap["activity-id"] = "c765d403-ded6-4864-9536-481d972e2f7f"
	inputMap["pgpencryptor_in_file_names"] = instance.EventMap["Transformer_M1"].Result["transform.out.file_names"]
	inputMap["pgpencryptor_in_file_path"] = instance.EventMap["Transformer_M1"].Result["transform.out.file_path"]
	...
	_, err = w.safeExecuteActivity(ctx, instance, "PGPEncryptorProxy", map[string]interface{}{"data_id": dataId})
	if err != nil {
		w.logger.Error("Workflow terminated during activity execution", zap.Error(err))
		return err
	}
	err = w.CustomUpdateHandler(ctx, instance, "PGPEncryptorProxy")
	if err != nil {
		return err
	}
	err = w.waitEvent(ctx, instance, input, "Pgp_Encrypter1", "pgp_enc")
	if err != nil {
		return err
	}
	...
	w.File_Copy2(ctx, instance, input)
	return nil
}

func (w *_RdexDemoFlowManager2) File_Copy2(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	instance.currentTask = "File_Copy2"
	instance.dataMap["current_task"] = instance.currentTask
	w.logger.Info("Executing task: File_Copy2\n")
	...
	inputMap := make(map[string]interface{})
	inputMap["filecopy_in_file_names"] = instance.EventMap["Pgp_Encrypter1"].Result["pgp_encryption.out.file_names"]
	inputMap["filecopy_in_file_path"] = instance.EventMap["Pgp_Encrypter1"].Result["pgp_encryption.out.file_path"]
	inputMap["activity-id"] = "13e40ad3-da23-4652-a29a-d8aa552a0b15"
	...
	err = w.waitEvent(ctx, instance, input, "File_Copy2", "file_copy.com")
	if err != nil {
		return err
	}
...
func (w *_RdexDemoFlowManager2) exit(ctx workflow.Context, instance *WorkflowInstance) {
