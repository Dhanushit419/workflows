...
// Document-Name: RdexDemoSprint2
// Version: 1
// Type or Namespace: _RdexDemoSprint2
// Dsl: 1
...
func New_RdexDemoSprint2(workflowIOManager dependencies.WorkflowIOManager) *_RdexDemoSprint2 {
	return &_RdexDemoSprint2{
		configMap:         map[string]interface{}{},
...
func (w *_RdexDemoSprint2) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _RdexDemoSprint2", err)
		return "", err
	}
...
func (w *_RdexDemoSprint2) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_RdexDemoSprint2) handleActivityRetryLoop(ctx workflow.Context, instance *WorkflowInstance, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
...
func (w *_RdexDemoSprint2) produceWorkflowEvent(ctx workflow.Context, eventType string, taskName string, payload map[string]interface{}) error {
...
func (w *_RdexDemoSprint2) safeExecuteActivity(ctx workflow.Context, instance *WorkflowInstance, activityName string, input interface{}) (interface{}, error) {
...
func (w *_RdexDemoSprint2) File_Copy1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	...
	inputMap["activity-id"] = "d54c38a1-b89d-42a3-a128-ab576ca2478a"
	inputMap["tenant_id"] = instance.EventMap["Trigger"].Result["tenant_id"]
	inputMap["correlation_id"] = instance.EventMap["Trigger"].Result["correlation_id"]
...
func (w *_RdexDemoSprint2) waitEvent(ctx workflow.Context, instance *WorkflowInstance, input interface{}, taskName string, EventType string) error {
...
func (w *_RdexDemoSprint2) CustomUpdateHandler(ctx workflow.Context, instance *WorkflowInstance, updateName string) error {
...
func (w *_RdexDemoSprint2) Pgp_Encrypter1(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	...
	inputMap := make(map[string]interface{})
	inputMap["activity-id"] = "31186044-d45e-4a7c-8fc0-60849e6bcc73"
	inputMap["pgpencryptor_in_file_names"] = instance.EventMap["File_Copy1"].Result["file_copy.out.file_names"]
	inputMap["pgpencryptor_in_file_path"] = instance.EventMap["File_Copy1"].Result["file_copy.out.file_path"]
	inputMap["tenant_id"] = instance.EventMap["Trigger"].Result["tenant_id"]
	inputMap["correlation_id"] = instance.EventMap["Trigger"].Result["correlation_id"]
	inputMap["workflow_id"] = workflow.GetInfo(ctx).WorkflowExecution.ID
	instance.dataMap["input"] = inputMap
...
func (w *_RdexDemoSprint2) File_Copy2(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	instance.currentTask = "File_Copy2"
	instance.dataMap["current_task"] = instance.currentTask
	w.logger.Info("Executing task: File_Copy2\n")
	//log EventMap["Pgp_Encrypter1"]
	w.logger.Info("EventMap[Pgp_Encrypter1]: %s", instance.EventMap["Pgp_Encrypter1"])
	inputMap := make(map[string]interface{})
	inputMap["activity-id"] = "1ba6a8a9-5c44-4f56-afc1-b9a457c615f0"
	event := instance.EventMap["Pgp_Encrypter1"]
	inputMap["filecopy_in_file_names"] = event.Result["pgp_encryption.out.file_names"]
	inputMap["filecopy_in_file_path"] = event.Result["pgp_encryption.out.file_path"]
	inputMap["tenant_id"] = instance.EventMap["Trigger"].Result["tenant_id"]
	inputMap["correlation_id"] = instance.EventMap["Trigger"].Result["correlation_id"]
	inputMap["workflow_id"] = workflow.GetInfo(ctx).WorkflowExecution.ID
	instance.dataMap["input"] = inputMap
...
func (w *_RdexDemoSprint2) exit(ctx workflow.Context, instance *WorkflowInstance) {
