...
// Document-Name: TestingPublish
// Version: draft
// Type or Namespace: _TestingPublish
// Dsl: draft
...
func New_TestingPublish(workflowIOManager dependencies.WorkflowIOManager) *_TestingPublish {
	return &_TestingPublish{
		configMap:         map[string]interface{}{},
...
func (w *_TestingPublish) Execute(ctx workflow.Context, input interface{}) (string, error) {
	...
	if err := workflow.SetQueryHandler(ctx, "getCurrentTask", func() (string, error) {
		...
		w.logger.Error("failed to register query handler : _TestingPublish", err)
		return "", err
	}
	...
	// Execute first task
	if err := w.Task3(ctx, instance,instance.dataMap); err != nil {
		return "", err
	}
...
func (w *_TestingPublish) PersistActualInput(ctx workflow.Context, data interface{}) (string, error) {
...
func (w *_TestingPublish) handleActivityRetryLoop(ctx workflow.Context, instance *WorkflowInstance, activityName, taskName string, execute func() (interface{}, error), initialError error) (interface{}, error) {
	...
	func (w *_TestingPublish) produceWorkflowEvent(ctx workflow.Context, eventType string, taskName string, payload map[string]interface{}) error {
...
func (w *_TestingPublish) safeExecuteActivity(ctx workflow.Context, instance *WorkflowInstance, activityName string, input interface{}) (interface{}, error) {
...
func (w *_TestingPublish) Task3(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	instance.currentTask = "Task3"
	instance.dataMap["current_task"] = instance.currentTask
	w.logger.Info("Executing task: Task3\n")
...
_, err = w.safeExecuteActivity(ctx,instance, "FileCopyProxy", map[string]interface{}{"data_id": dataId})
	...
	err = w.waitEvent(ctx, instance, input, "Task3", "file_copy.com")
	if err != nil {
		return err
	}
	...
	if err != nil {
		...
		w.Task4(ctx,instance, input)
	return nil
}



func (w *_TestingPublish) waitEvent(ctx workflow.Context, instance *WorkflowInstance, input interface{}, taskName string, EventType string) error {
...
func (w *_TestingPublish) CustomUpdateHandler(ctx workflow.Context, instance *WorkflowInstance, updateName string) error {
...
func (w *_TestingPublish) Task4(ctx workflow.Context, instance *WorkflowInstance, input interface{}) error {
	instance.previousTask = instance.currentTask
	instance.currentTask = "Task4"
	instance.dataMap["current_task"] = instance.currentTask
	w.logger.Info("Executing task: Task4\n")
...
_, err = w.safeExecuteActivity(ctx,instance, "FileCopyProxy", map[string]interface{}{"data_id": dataId})
	...
	err = w.waitEvent(ctx, instance, input, "Task4", "file_copy.com")
	if err != nil {
		return err
	}
...
func (w *_TestingPublish) exit(ctx workflow.Context,instance *WorkflowInstance) {
